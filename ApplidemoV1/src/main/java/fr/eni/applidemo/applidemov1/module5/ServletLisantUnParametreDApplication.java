package fr.eni.applidemo.applidemov1.module5;
...
public class ServletLisantUnParametreDApplication extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("L'email de l'administratuer est : " + emailAdministrateur);
		out.println("linformation est accessible depuis toutes les servelets et JSP");
